...
function activateTrail(trail) {
    ...
    imagesContainer.style.left =
        -(activeTrail.dataset.order - 1) *
            document.getElementById("banner").getBoundingClientRect().width +
        "px";
        console.log(document.getElementById("banner").getBoundingClientRect().width);
}
